...
However there were a lot of concerns with security, because if we are opening each platform up to share a communication channel with another platform(s) then we have to consider the fact that not all platforms have the same level of encryption and security for your messages. What is stopping someone from hacking into slack and now having access to all your messages in Telegram and Whatsapp at the same time? 
